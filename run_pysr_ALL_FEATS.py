...
def get_args(): 
    ...
    parser.add_argument("--all_df_picklefile",   type=str,  default="/mnt/home/dsalim/SYMR_STARFORMATION/all_galaxies_all_params_redshift_bins_df.pickle",
                            help="directory and filename of picklefile containing all extracted data from galaxy hdf files")
    parser.add_argument("--savepath",            type=str,  default="/mnt/home/dsalim/SYMR_STARFORMATION/RUN_XGB_SHAP_PYSR_ZBINS/", 
                            help="directory to save analysis plots")
    parser.add_argument("--xgb_picklefile",      type=str,  default="/mnt/home/dsalim/SYMR_STARFORMATION/RUN_XGB_SHAP_PYSR_ZBINS/xgb_shap_z0_z0pt5_SFR_10MYR.pickle",
