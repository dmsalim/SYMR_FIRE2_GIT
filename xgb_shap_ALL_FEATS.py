...
def write_sh_script(z_str, xgb_picklefile, sfr_type, redshift_index=None, pixel_width=750, n_epochs=10000, n_saves=5, disk_type=None, input_df_picklefile=None, savepath="/mnt/home/dsalim/SYMR_STARFORMATION/RUN_XGB_SHAP_PYSR_ZBINS/"):
    ...
    fid.wl("cd /mnt/home/dsalim/SYMR_STARFORMATION/")
